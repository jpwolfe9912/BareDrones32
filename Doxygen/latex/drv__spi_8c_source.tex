...
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00157}00157     reg = reg | 0x80;           \textcolor{comment}{// read operation}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00158}00158 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00159}00159     DMA2\_Stream0-\/>CR    \&= \string~DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00160}00160     \textcolor{keywordflow}{while}(DMA2\_Stream0-\/>CR \& DMA\_SxCR\_EN);}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00161}00161     DMA2\_Stream0-\/>CR    |= (0x3 << 25U);}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00162}00162     DMA2\_Stream0-\/>NDTR  = size;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00163}00163     DMA2\_Stream0-\/>M0AR  = (uint32\_t)pData;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00164}00164 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00165}00165     DMA2\_Stream3-\/>CR    \&= \string~DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00166}00166     \textcolor{keywordflow}{while}(DMA2\_Stream3-\/>CR \& DMA\_SxCR\_EN);}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00167}00167     DMA2\_Stream3-\/>CR    |= (0x3 << 25U);}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00168}00168     DMA2\_Stream3-\/>NDTR  = size;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00169}00169     DMA2\_Stream3-\/>M0AR  = (uint32\_t)\&reg;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00170}00170 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00171}00171     \mbox{\hyperlink{drv__spi_8h_a969f555816dfb8f48a85c1795ff5e63d}{SPI1\_ENABLE}};}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00172}00172 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00173}00173     DMA2\_Stream0-\/>CR    |= DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00174}00174     DMA2\_Stream3-\/>CR    |= DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00175}00175 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00176}00176     SPI1-\/>CR2           |= SPI\_CR2\_RXDMAEN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00177}00177     SPI1-\/>CR2           |= SPI\_CR2\_TXDMAEN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00178}00178 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00179}00179     SPI1-\/>CR1           |= SPI\_CR1\_SPE;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00180}00180 \}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00181}00181 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00189}00189 \textcolor{keywordtype}{void}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00190}\mbox{\hyperlink{drv__spi_8c_a7d61fb36806c4e37a2bf675ba2d62008}{00190}} \mbox{\hyperlink{drv__spi_8c_a7d61fb36806c4e37a2bf675ba2d62008}{spiWriteBytes}}(uint8\_t *pData, uint8\_t size)\{}
...
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00228}00228     reg |= 0x80;        \textcolor{comment}{// read operation}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00229}00229 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00230}00230     DMA2\_Stream0-\/>CR    \&= \string~DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00231}00231     \textcolor{keywordflow}{while}(DMA2\_Stream0-\/>CR \& DMA\_SxCR\_EN);}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00232}00232     DMA2\_Stream0-\/>CR    |= (0x3 << 25U);}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00233}00233     DMA2\_Stream0-\/>NDTR  = 3;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00234}00234     DMA2\_Stream0-\/>M0AR  = (uint32\_t)pData;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00235}00235 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00236}00236     DMA2\_Stream3-\/>CR    \&= \string~DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00237}00237     \textcolor{keywordflow}{while}(DMA2\_Stream3-\/>CR \& DMA\_SxCR\_EN);}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00238}00238     DMA2\_Stream3-\/>CR    |= (0x3 << 25U);}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00239}00239     DMA2\_Stream3-\/>NDTR  = 3;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00240}00240     DMA2\_Stream3-\/>M0AR  = (uint32\_t)\&reg;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00241}00241 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00242}00242     \mbox{\hyperlink{drv__spi_8h_a969f555816dfb8f48a85c1795ff5e63d}{SPI1\_ENABLE}};}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00243}00243 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00244}00244     DMA2\_Stream0-\/>CR    |= DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00245}00245     DMA2\_Stream3-\/>CR    |= DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00246}00246 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00247}00247     SPI1-\/>CR2           |= SPI\_CR2\_RXDMAEN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00248}00248     SPI1-\/>CR2           |= SPI\_CR2\_TXDMAEN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00249}00249 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00250}00250     SPI1-\/>CR1           |= SPI\_CR1\_SPE;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00251}00251 \}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00252}00252 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00259}00259 \textcolor{keywordtype}{void}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00260}\mbox{\hyperlink{drv__spi_8c_aebb1dda4e95fbaba094d5beb79073279}{00260}} \mbox{\hyperlink{drv__spi_8c_aebb1dda4e95fbaba094d5beb79073279}{spiWriteOneByte}}(uint8\_t reg, uint8\_t data)\{}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00261}00261     \textcolor{comment}{// need to pass in array of values to be written}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00262}00262     \textcolor{comment}{// RX Setup}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00263}00263     \textcolor{keyword}{volatile} uint8\_t dummy \mbox{\hyperlink{main_8c_a98fd71583f8abd1b1b12cfe80e3bd29a}{\_\_attribute\_\_}}((unused));}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00264}00264     uint8\_t \mbox{\hyperlink{drv__serial_8c_a3cc119cb1a4beab046568bd21fcac3e5}{temp}}[2] = \{reg, data\};}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00265}00265 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00266}00266     DMA2\_Stream0-\/>CR    \&= \string~DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00267}00267     \textcolor{keywordflow}{while}(DMA2\_Stream0-\/>CR \& DMA\_SxCR\_EN);}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00268}00268     DMA2\_Stream0-\/>CR    |= (0x3 << 25U);}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00269}00269     DMA2\_Stream0-\/>NDTR  = 2;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00270}00270     DMA2\_Stream0-\/>M0AR  = (uint32\_t)\&dummy;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00271}00271     \textcolor{comment}{// TX Setup}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00272}00272     \textcolor{comment}{// perhaps include a circular buffer}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00273}00273     DMA2\_Stream3-\/>CR    \&= \string~DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00274}00274     \textcolor{keywordflow}{while}(DMA2\_Stream3-\/>CR \& DMA\_SxCR\_EN);}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00275}00275     DMA2\_Stream3-\/>CR    |= (0x3 << 25U);}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00276}00276     DMA2\_Stream3-\/>NDTR  = 2;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00277}00277     DMA2\_Stream3-\/>M0AR  = (uint32\_t)\mbox{\hyperlink{drv__serial_8c_a3cc119cb1a4beab046568bd21fcac3e5}{temp}};}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00278}00278 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00279}00279     \mbox{\hyperlink{drv__spi_8h_a969f555816dfb8f48a85c1795ff5e63d}{SPI1\_ENABLE}};}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00280}00280 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00281}00281     DMA2\_Stream0-\/>CR    |= DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00282}00282     DMA2\_Stream3-\/>CR    |= DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00283}00283 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00284}00284     SPI1-\/>CR2           |= SPI\_CR2\_RXDMAEN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00285}00285     SPI1-\/>CR2           |= SPI\_CR2\_TXDMAEN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00286}00286 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00287}00287     SPI1-\/>CR1           |= SPI\_CR1\_SPE;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00288}00288 \}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00289}00289 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00290}00290 \textcolor{comment}{/* Interrupt Handlers */}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00291}00291 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00295}00295 \textcolor{keywordtype}{void}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00296}\mbox{\hyperlink{drv__spi_8c_aaf6ce196dde98712e1223b99766e06c0}{00296}} \mbox{\hyperlink{drv__spi_8c_aaf6ce196dde98712e1223b99766e06c0}{DMA2\_Stream0\_IRQHandler}}(\textcolor{keywordtype}{void})}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00297}00297 \{}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00298}00298     \textcolor{keywordflow}{if}(DMA2-\/>LISR \& DMA\_LISR\_TCIF0)\{}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00299}00299         DMA2-\/>LIFCR     |= DMA\_LIFCR\_CTCIF0;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00300}00300 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00301}00301         \mbox{\hyperlink{drv__spi_8h_af64f6dca6126f4fb9299c912c7f8ad81}{SPI1\_DISABLE}};}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00302}00302 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00303}00303         DMA2\_Stream0-\/>CR    \&= \string~DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00304}00304         DMA2\_Stream3-\/>CR    \&= \string~DMA\_SxCR\_EN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00305}00305 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00306}00306         SPI1-\/>CR2           \&= \string~SPI\_CR2\_RXDMAEN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00307}00307         SPI1-\/>CR2           \&= \string~SPI\_CR2\_TXDMAEN;}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00308}00308 }
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00309}00309         SPI1-\/>CR1           \&= \string~SPI\_CR1\_SPE;}
...
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00317}00317 \textcolor{keywordtype}{void}}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00318}\mbox{\hyperlink{drv__spi_8c_a877135f6494d6923d6f6ec32d75d9eeb}{00318}} \mbox{\hyperlink{drv__spi_8c_a877135f6494d6923d6f6ec32d75d9eeb}{DMA2\_Stream3\_IRQHandler}}(\textcolor{keywordtype}{void})}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00319}00319 \{}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00320}00320     \textcolor{keywordflow}{if}(DMA2-\/>LISR \& DMA\_LISR\_TCIF3)\{}
\DoxyCodeLine{\Hypertarget{drv__spi_8c_source_l00321}00321         DMA2-\/>LIFCR     |= DMA\_LIFCR\_CTCIF3;}
