...
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00090}00090     SysTick-\/>CTRL   \&= \string~SysTick\_CTRL\_ENABLE\_Msk;    \textcolor{comment}{// disable systick interrupts}}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00091}00091 }
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00092}00092     \textcolor{keywordtype}{float} speed = 0.5;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00093}00093 }
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00094}00094     EXTI-\/>IMR       \&= \string~(EXTI\_IMR\_IM13 |    \textcolor{comment}{// turn off GPIO interrupts}}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00095}00095                          EXTI\_IMR\_IM14);}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00096}00096     TIM1-\/>CCER      |= TIM\_CCER\_CC1E |      \textcolor{comment}{// enables channel 1 as output}}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00097}00097                        TIM\_CCER\_CC2E;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00098}00098 }
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00099}00099     \textcolor{keywordflow}{if}(\mbox{\hyperlink{process__commands_8c_abdda914a8c6ac0445832f7dbf4f37286}{mode}} == \mbox{\hyperlink{_autodrone32_8h_ada81cad6f64bf0042dba36096bf32710a8ff0f0e920a26f5210452e85eabc54d3}{TRANS\_FLIGHT}})}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00100}00100     \{}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00101}00101         GPIOC-\/>BSRR |= GPIO\_BSRR\_BR8;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00102}00102         TIM1-\/>CCR1 = (uint32\_t)(5082 * speed) -\/ 1;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00103}00103 }
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00104}00104         GPIOC-\/>BSRR |= GPIO\_BSRR\_BR9;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00105}00105         TIM1-\/>CCR2 = (uint32\_t)(5082 * speed) -\/ 1;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00106}00106     \}}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00107}00107     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(\mbox{\hyperlink{process__commands_8c_abdda914a8c6ac0445832f7dbf4f37286}{mode}} == \mbox{\hyperlink{_autodrone32_8h_ada81cad6f64bf0042dba36096bf32710a8dc5461871ae730fcc0b532526747d60}{TRANS\_ROVER}})}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00108}00108     \{}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00109}00109         GPIOC-\/>BSRR |= GPIO\_BSRR\_BS8;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00110}00110         TIM1-\/>CCR1 = (uint32\_t)(5082 * speed) -\/ 1;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00111}00111 }
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00112}00112         GPIOC-\/>BSRR |= GPIO\_BSRR\_BS9;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00113}00113         TIM1-\/>CCR2 = (uint32\_t)(5082 * speed) -\/ 1;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00114}00114     \}}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00115}00115     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00116}00116     \{}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00117}00117         TIM1-\/>CCR1 = 0;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00118}00118         TIM1-\/>CCR2 = 0;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00119}00119     \}}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00120}00120 }
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00121}00121     \mbox{\hyperlink{drv__system_8c_a7f2dfce1046bdd2a2b753643726c2346}{delay}}(100);}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00122}00122     EXTI-\/>IMR       |= EXTI\_IMR\_IM13 |      \textcolor{comment}{// wait for arm to be clear of limit switch}}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00123}00123                        EXTI\_IMR\_IM14;       \textcolor{comment}{// and then turn interrupts back on}}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00124}00124 \}}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00125}00125 }
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00126}00126 \textcolor{keywordtype}{void}}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00127}\mbox{\hyperlink{drv__worm_8c_a738473a5b43f6c92b80ce1d3d6f77ed9}{00127}} \mbox{\hyperlink{drv__worm_8c_a738473a5b43f6c92b80ce1d3d6f77ed9}{EXTI15\_10\_IRQHandler}}(\textcolor{keywordtype}{void})}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00128}00128 \{}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00129}00129     \textcolor{keywordflow}{if}(EXTI-\/>PR \& EXTI\_PR\_PR13)\{}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00130}00130         EXTI-\/>PR |= EXTI\_PR\_PR13;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00131}00131         TIM1-\/>CCER \&= \string~TIM\_CCER\_CC1E;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00132}00132         \mbox{\hyperlink{drv__worm_8c_ace909de44fd65d7cc09fe9d11178fb43}{arm1Hit}} = \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00133}00133     \}}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00134}00134     \textcolor{keywordflow}{if}(EXTI-\/>PR \& EXTI\_PR\_PR14)\{}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00135}00135         EXTI-\/>PR |= EXTI\_PR\_PR14;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00136}00136         TIM1-\/>CCER \&= \string~TIM\_CCER\_CC2E;}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00137}00137         \mbox{\hyperlink{drv__worm_8c_a96647bc245d39fa8c5c78abdf530cf19}{arm2Hit}} = \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00138}00138     \}}
\DoxyCodeLine{\Hypertarget{drv__worm_8c_source_l00139}00139 \}}
