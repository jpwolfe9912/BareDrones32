...
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00056}00056     \mbox{\hyperlink{drv__system_8c_a7f2dfce1046bdd2a2b753643726c2346}{delay}}(100);}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00057}00057     \textcolor{keywordflow}{for}(uint8\_t i = 0; i < 10; i++)}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00058}00058     \{}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00059}00059         \mbox{\hyperlink{battery_8c_a597d861d523b1711af5e13d421ceac25}{battMonRead}}();}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00060}00060         summedVoltage += \mbox{\hyperlink{battery_8c_a855408c36f973de1305b920c1e2d7125}{battVoltage}};}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00061}00061         \mbox{\hyperlink{drv__system_8c_a7f2dfce1046bdd2a2b753643726c2346}{delay}}(1);}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00062}00062     \}}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00063}00063     avgVoltage = summedVoltage / 10.0f;}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00064}00064 }
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00065}00065     \textcolor{keywordflow}{if}((avgVoltage >= 10.0f) \&\& (avgVoltage < 13.3))}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00066}00066         \textcolor{keywordflow}{return} \mbox{\hyperlink{battery_8h_a065db3c6827b30adb091f74d479ed862a1251fbf93888ad32fe0ae54d49bcef17}{THREE}};}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00067}00067     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}((avgVoltage >= 13.3) \&\& (avgVoltage < 17.15))}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00068}00068         \textcolor{keywordflow}{return} \mbox{\hyperlink{battery_8h_a065db3c6827b30adb091f74d479ed862a23d7ef5341c6930d19b2ecbb997977cf}{FOUR}};}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00069}00069     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}((avgVoltage >= 17.15) \&\& (avgVoltage < 21))}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00070}00070         \textcolor{keywordflow}{return} \mbox{\hyperlink{battery_8h_a065db3c6827b30adb091f74d479ed862a3a40d11d30db182ab8f9846aa9458bec}{FIVE}};}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00071}00071     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(avgVoltage >= 21)}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00072}00072         \textcolor{keywordflow}{return} \mbox{\hyperlink{battery_8h_a065db3c6827b30adb091f74d479ed862aadffddd32c3e7497e32cd7e430c9c106}{SIX}};}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00073}00073     \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00074}00074         \textcolor{keywordflow}{return} \mbox{\hyperlink{battery_8h_a065db3c6827b30adb091f74d479ed862a5aae27054572160c56fe3ae2aea1745a}{NO\_BATT}};}
...
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00082}00082 \textcolor{keyword}{static} \textcolor{keywordtype}{void}}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00083}00083 batt\_warning(\textcolor{keywordtype}{void})}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00084}00084 \{}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00085}00085     \textcolor{keywordflow}{if}(\mbox{\hyperlink{battery_8c_acaa90e358397010f1098d4c1fbcf3566}{cells}} != 0)}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00086}00086     \{}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00087}00087         \textcolor{keywordflow}{if}(\mbox{\hyperlink{battery_8c_a855408c36f973de1305b920c1e2d7125}{battVoltage}} < (\mbox{\hyperlink{battery_8c_acaa90e358397010f1098d4c1fbcf3566}{cells}} * 3.5))\{}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00088}00088             \mbox{\hyperlink{drv__color_8c_a51793d1b3d6e4669841c63ba39e428ce}{color}}(\mbox{\hyperlink{drv__color_8h_a0a204139fa728b63f637526a181ca979af80f9a890089d211842d59625e561f88}{RED}}, \mbox{\hyperlink{drv__color_8h_a3754b48ed3011b2b338eb948daa47cd7a99f136a862ba5c7d16967231c29f09d6}{YES}});}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00089}00089             printf(\textcolor{stringliteral}{"{}\(\backslash\)nBATTERY EMPTY\(\backslash\)n"{}});}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00090}00090             \mbox{\hyperlink{drv__color_8c_aa926233cbec85dc0871fdf95d7406dbe}{colorDefault}}();}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00091}00091             \mbox{\hyperlink{battery_8c_a04b408c49d3fb293aacb6f23bf88b3a1}{battEmpty}} = \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00092}00092         \}}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00093}00093         \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(\mbox{\hyperlink{battery_8c_a855408c36f973de1305b920c1e2d7125}{battVoltage}} < (\mbox{\hyperlink{battery_8c_acaa90e358397010f1098d4c1fbcf3566}{cells}} * 3.7))\{}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00094}00094             \mbox{\hyperlink{drv__color_8c_a51793d1b3d6e4669841c63ba39e428ce}{color}}(\mbox{\hyperlink{drv__color_8h_a0a204139fa728b63f637526a181ca979ae735a848bf82163a19236ead1c3ef2d2}{YELLOW}}, \mbox{\hyperlink{drv__color_8h_a3754b48ed3011b2b338eb948daa47cd7a99f136a862ba5c7d16967231c29f09d6}{YES}});}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00095}00095             printf(\textcolor{stringliteral}{"{}\(\backslash\)nBATTERY LOW\(\backslash\)n"{}});}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00096}00096             \mbox{\hyperlink{drv__color_8c_aa926233cbec85dc0871fdf95d7406dbe}{colorDefault}}();}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00097}00097             \mbox{\hyperlink{battery_8c_ab7ebcda2eb57227df52a41b5f8c306b2}{battLow}} = \textcolor{keyword}{true};}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00098}00098         \}}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00099}00099         \textcolor{keywordflow}{else}}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00100}00100         \{}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00101}00101             \mbox{\hyperlink{battery_8c_ab7ebcda2eb57227df52a41b5f8c306b2}{battLow}} = \textcolor{keyword}{false};}
\DoxyCodeLine{\Hypertarget{battery_8c_source_l00102}00102             \mbox{\hyperlink{battery_8c_a04b408c49d3fb293aacb6f23bf88b3a1}{battEmpty}} = \textcolor{keyword}{false};}
