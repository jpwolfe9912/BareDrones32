 ...
 */
void
spi2ReadBytes(uint8_t reg, uint8_t *pData, uint8_t size)
{
 ...
 */
void
spi2WriteBytes(uint8_t *pData, uint8_t size)
{
	// RX Setup
 ...
 */
void
spi2ReadOneByte(uint8_t reg, uint8_t *pData)
{
 ...
 */
void
spi2WriteOneByte(uint8_t reg, uint8_t data)
{
