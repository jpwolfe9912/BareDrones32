...
void printfInit(void)
{
    // TX3 : PB10 : AF7
    // RX3 : PB11 : AF7
    RCC->AHB1ENR |= RCC_AHB1ENR_GPIOBEN;  // enable the clock for port C
    ...
    USART3->CR1 |= USART_CR1_RE | USART_CR1_TE | USART_CR1_UE; // enable the receiver, transmitter, and USART								// enable USART3 interrupts on the NVIC (nested vector interrupt controller)
}
#endif
...
void printfReadPID(float *P, float *I, float *D)
{
    ...
    sscanf((char *)printfBuf, "%f, %f, %f", P, I, D);
